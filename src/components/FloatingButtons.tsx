  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        href={CALL_URL}
        aria-label="Call us"
        className="size-14 rounded-full bg-cyan-press text-background flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
      >
